...
//             // Filter by role 'master' in frontend
//             const masterUsers = response.data.filter(client => client.role === 'master');
...
//     // Update ledger entries when master is selected
//     useEffect(() => {
...
//         if (!clientObj) {
//             alert('Selected master not found.');
//             return;
//         }
...
//                 <div className="title">Master Transactions</div>
...
//                             <label><span className="required">*</span>Master</label>
...
//                             No ledger entries found for this master.
//                         </div>
//                     )}
//                 </div>
//             )}
...
const ClientLenden = () => {
    ...
    // Calculate totals for the selected master with grouped matches
